...
namespace Tabbles.OutlookAddIn
{
    class ItemManager
    {
        ...
        /// <summary>
        /// Saves the mail and after executes the callbackAction.
        /// If was called several times at once for the mail items of the same folder
        /// calls callbackAction only once (this is achieved by weird dictionaries above).
        /// </summary>
